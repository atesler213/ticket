      ...
      <div class="col-span-8">
        ...
        <div class="table-container mb-6 animate-slide-up">
          <div class="table-header">
            ...
            <router-link :to="{ name: 'admin.tickets' }" class="table-link">View All Tickets</router-link>
          </div>
          ...
          <div class="flex justify-center py-4 border-t border-gray-100">
            <router-link :to="{ name: 'admin.tickets' }" class="btn btn-ghost btn-sm">View All Tickets <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></router-link>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6 mb-6">
          ...
          <div class="card card-no-hover animate-slide-up">
            <div class="card-header" style="padding: 16px 20px;">
              ...
              <router-link :to="{ name: 'admin.tickets' }" class="text-sm font-medium text-blue-600">View All</router-link>
            </div>
        ...
        <!-- License Usage & System Integrations (Admin Specific) -->
        <div class="grid grid-cols-2 gap-6">
          <div class="card card-no-hover animate-slide-up">
            <div class="card-header" style="padding:16px 20px;">
              <h3 class="text-[15px] font-semibold text-gray-900">License Usage</h3>
              <router-link :to="{ name: 'admin.licenses' }" class="text-sm font-medium text-blue-600">Manage</router-link>
            </div>
